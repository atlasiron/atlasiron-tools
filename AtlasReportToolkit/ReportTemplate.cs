...
namespace AtlasReportToolkit
{
    ...
    public class ReportTemplate
    {
        ...
        public void FillReferenceLists(String operation,ReportDefinitions definitions)
        {
            foreach (ReportTemplateColumn column in this.Header)
            {
                ...
                String referenceListName = column.ReferenceListName.Replace(EditReportSheetCtrl.ReportOperationField, operation);
